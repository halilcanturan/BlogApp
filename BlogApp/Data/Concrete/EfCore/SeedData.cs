            ...
            if (context != null)
            {
                ...
                if (!context.Users.Any())
                {
                    context.Users.AddRange(
                        new User { UserName = "canturan",Name="Can TURAN",Email="info@canturan.com",Password="123456", Image = "p1.jpg" },
                        new User { UserName = "atlasturan",Name="Atlas TURAN",Email="info@atlasturan.com", Password = "123456", Image = "p2.jpg" }
                    );
                    context.SaveChanges();
                }
                ...
                if (!context.Posts.Any())
                {
                    context.Posts.AddRange(
                        new Post
                        {
                            ...
                            new Comment {Text="çok faydalı bir kurs", PublishedOn=new DateTime(),UserId=2 }}
                        },
                        new Post
                        {
                            Title = "Php",
